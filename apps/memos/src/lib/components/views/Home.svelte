                  ...
                  {:else}
                    ...
                    >
                      ...
                      <span class="hidden sm:inline"
                        >{memo.favorite ? "Unfavorite" : "Favorite"}</span
                      >
                    </Button>
                    <Button
                      variant="ghost"
                    ...
                    <Button
                      ...
                      title="Archive memo"
                    >
                      <Archive size={12} /><span class="hidden sm:inline"
                    ...
                    >
                      <Share2 size={12} /><span class="hidden sm:inline"
                    ...
                    <Button
                      ...
                      title="Delete memo"
                    >
                      <Trash2 size={12} /><span class="hidden sm:inline">Delete</span>
                    </Button>
                  {/if}
                </div>
              </div>
